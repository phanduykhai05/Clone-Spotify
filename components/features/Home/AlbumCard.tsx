...
export function AlbumCard({ album }: AlbumCardProps) {
  ...
  return (
    ...
    >
      <div className="relative w-[160px] h-[160px] rounded-sm overflow-hidden mb-3 bg-[#282828]">
        {album.coverUrl ? (
          <Image
            src={album.coverUrl}
            alt={album.name}
      ...
      <p className="text-[#a7a7a7] text-xs truncate mt-0.5">{artistNames} • {album.year}</p>
    </Link>
  );
}
