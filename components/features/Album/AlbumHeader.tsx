    ...
    <div className="flex items-end gap-6 px-6 pt-6 pb-6 bg-gradient-to-b from-[#5038a0] to-[#121212]">
      ...
      <div className="flex flex-col gap-2 min-w-0">
        ...
        <div className="flex items-center gap-1 text-sm text-white mt-2">
          ...
          <span className="text-[#a7a7a7]"> • {album.year} • {album.tracks.length} songs</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 mt-6">
        ...
        <button aria-label="Save to library" className="text-[#a7a7a7] hover:text-white transition-colors cursor-pointer">
        ...
        <Button variant="ghost" className="text-xs">...</Button>
      </div>
    </div>
  );
}
