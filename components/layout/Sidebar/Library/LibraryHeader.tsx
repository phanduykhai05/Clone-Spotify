  ...
  return (
    <div className="flex items-center justify-between px-4 py-2">
      ...
      <div className="flex items-center gap-1">
        ...
        <button aria-label="Show more" className="w-8 h-8 flex items-center justify-center text-[#a7a7a7] hover:text-white transition-colors rounded-full hover:bg-[#282828] cursor-pointer">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
